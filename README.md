...
[grap_change_translation](grap_change_translation/) | 12.0.2.1.0 |  | Disable the translation mechanism for a many fields
...
[grap_change_views_product](grap_change_views_product/) | 12.0.0.4.0 |  | GRAP - Change Views Product
...
[grap_cooperative](grap_cooperative/) | 12.0.3.1.0 |  | Add Directories, Companies, Colleges, Peoples, etc.
...
[grap_qweb_report](grap_qweb_report/) | 12.0.2.2.0 |  | GRAP - Custom Qweb Reports
...
[mrp_bom_line_net_qty](mrp_bom_line_net_qty/) | 12.0.1.1.2 |  | MRP BoM Line Net and Gross Quantity
